...
export class DatePicker extends BaseInput<DatePickerPassThrough> {
    ...
    /**
     * Whether to display year in Buddhist era.
     * @group Props
     */
    @Input({ transform: booleanAttribute }) isBudhistYear: boolean = false;
    ...
    onYearSelect(event: Event, year: number) {
        if (this.view === 'year') {
            this.onDateSelect(event, { year: year - this.yearBudhist, month: 0, day: 1, selectable: true });
        } else {
            this.currentYear = year - this.yearBudhist;
            this.setCurrentView('month');
    ...
    getYear(month: any) {
        return (this.currentView === 'month' ? this.currentYear : month.year) + this.yearBudhist;
    }
                ...
                if (literal) {
                    ...
                    switch (format.charAt(iFormat)) {
                        ...
                        case 'M':
                            ...
                            break;
                        case 'y':
                            let year = date.getFullYear() + this.yearBudhist;
